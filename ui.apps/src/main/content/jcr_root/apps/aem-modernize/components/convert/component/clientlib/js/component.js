...
$(document).ready(function () {
    ...
    var REMOTE_COMPONENT_CONVERSION_SERVICE_PATH = "/apps/aem-modernize/content/component/_jcr_content.convert.json";
    ...
    function init () {
        ...
        convertComponentsButton.on("click", function () {
            ...
            var url = REMOTE_COMPONENT_CONVERSION_SERVICE_PATH;
            var data = {
                paths : paths
            };
