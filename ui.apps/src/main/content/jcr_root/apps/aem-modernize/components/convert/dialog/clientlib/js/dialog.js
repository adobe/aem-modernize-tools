...
$(document).ready(function () {
    ...
    var REMOTE_DIALOG_CONVERSION_SERVICE_PATH = "/apps/aem-modernize/content/dialog/_jcr_content.convert.json";

    var ui = $(window).adaptTo("foundation-ui");

    var dialogRows;
    var convertedRows = [];
    var dialogConverterContainer = document.querySelector(".js-aem-DialogConverter-container");
    var showConverted = document.querySelector(".js-aem-DialogConverter-showConvertedDialogRows");
    var searchPathField = document.querySelector(".js-aem-DialogConverter-searchPath");
    var infoText = document.querySelector(".js-aem-DialogConverter-infoText");
    var showDialogsButton = document.querySelector(".js-aem-DialogConverter-showDialogs");
    var backButton = document.querySelector(".js-aem-DialogConverter-back");
    var convertDialogsButton = document.querySelector(".js-aem-DialogConverter-convertDialogs");
    var dialogSearch = document.querySelector(".js-aem-DialogConverter-dialogSearch");
    var convertedDialogs = document.querySelector(".js-aem-DialogConverter-convertedDialogs");
    var dialogTable = document.querySelector(".js-aem-DialogConverter-dialogs");
    ...
    function init () {
        ...
        convertDialogsButton.on("click", function () {
            ...
            var url = REMOTE_DIALOG_CONVERSION_SERVICE_PATH;
            var data = {
                paths : paths
            };
