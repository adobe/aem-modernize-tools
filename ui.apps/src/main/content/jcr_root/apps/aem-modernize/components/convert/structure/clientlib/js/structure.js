...
$(document).ready(function () {
    ...
    var REMOTE_STRUCTURE_CONVERSION_SERVICE_PATH = "/apps/aem-modernize/content/structure/_jcr_content.convert.json";
    ...
    function init () {
        ...
        convertPagesButton.on("click", function () {
            ...
            var url = REMOTE_STRUCTURE_CONVERSION_SERVICE_PATH;
            var data = {
                paths : paths
            };
