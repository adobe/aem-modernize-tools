 ...
 */
public interface ComponentRewriteRule {
     ...
     * specified set.
     *
     * <p>{@link ComponentRewriteUtils} provides utility methods that can
     ...
     * @throws ComponentRewriteException if the rewrite operation failed or cannot be completed
     */
