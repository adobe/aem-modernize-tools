...
public class PageDataSourceTest {
    ...
    private static final String PAGE_ROOT = "/apps/aem-modernize/content/content/structure";
    private static final String ITEM_RESOURCE_TYPE = "aem-modernize/content/structure/item";
