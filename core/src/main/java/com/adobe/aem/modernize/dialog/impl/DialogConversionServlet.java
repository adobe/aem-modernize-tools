...
@Component(
    ...
    property = {
        SLING_SERVLET_RESOURCE_TYPES + "=aem-modernize/components/convert/dialog",
...
public class DialogConversionServlet extends SlingAllMethodsServlet {
     ...
     */
    public static final String RULES_SEARCH_PATH = "aem-modernize/components/convert/dialog/rules";
